  ...
  <body>
    ...
    <div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Payment Types
				<strong>Form</strong>
			</h2>
			<hr class="divider">
			<form action="configuration/paymentconfig.php" method="post">
				<center>
					<div class="row">
					<div class="form-group col-lg-12">
						<label class="text-heading">Payment ID</label>
						<input type="text" class="form-control" name="payment_id">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Payment Name</label>
