  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0"><strong>Insert</strong></h2>
        <hr class="divider">
		<div class="inserts"
		<br/>
			<a href="manager_insert.php" class="dashboard-module">
                <img src="img/manager_icon.png"  width="75" height="75" alt="edit" />
                <span>Manager</span>
            </a>
                  
            <a href="customer_insert.php" class="dashboard-module">
                <img src="img/customer.jpg" width="75" height="75" alt="edit" />
                <span>Customer</span>
            </a>
			
			<a href="company_insert.php" class="dashboard-module">
                <img src="img/company.jpg"  width="75" height="75" alt="edit" />
                <span>Company</span>
            </a>
		
			<a href="drug_insert.php" class="dashboard-module">
                <img src="img/drug.jpg"  width="75" height="75" alt="edit" />
                <span>Drug</span>
            </a>
			
			<a href="payment_insert.php" class="dashboard-module">
                <img src="img/payment.png"  width="75" height="75" alt="edit" />
                <span>Payment Types</span>
            </a>
			
			<a href="stock_insert.php" class="dashboard-module">
                <img src="img/stock.png"  width="75" height="75" alt="edit" />
                <span>Stock</span>
            </a>
