  ...
  <body>
    ...
    <div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Manager
				<strong>Form</strong>
			</h2>
			<hr class="divider">
			<form action="configuration/managerconfig.php" method="post">
				<center>
					<div class="row">
					<div class="form-group col-lg-12">
						<label class="text-heading">Manager ID</label>
						<input type="text" class="form-control" name="manager_id">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Manager Name</label>
						<input type="text" class="form-control" name="manager_name">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Manager Phone No</label>
						<input type="text" class="form-control" name="manager_phone_no">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Manager Address</label>
