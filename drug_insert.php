  ...
  <body>
    ...
    <div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Drug
				<strong>Form</strong>
			</h2>
			<hr class="divider">
			<form action="configuration/drugconfig.php" method="post">
				<center>
					<div class="row">
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug ID</label>
						<input type="text" class="form-control" name="drug_id">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug Name</label>
						<input type="text" class="form-control" name="drug_name">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug Category</label>
						<input type="text" class="form-control" name="drug_category">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug Company</label>
						<input type="text" class="form-control" name="drug_company">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug Description</label>
						<input type="text" class="form-control" name="drug_desp">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Drug Cost</label>
						<input type="text" class="form-control" name="drug_cost">
					</div>
