  ...
  <body>
    ...
    <div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Company
				<strong>Form</strong>
			</h2>
			<hr class="divider">
			<form action="configuration/companyconfig.php" method="post">
				<center>
					<div class="row">
					<div class="form-group col-lg-12">
						<label class="text-heading">Company Invoice ID</label>
						<input type="text" class="form-control" name="company_invoice_id">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Company Name</label>
						<input type="text" class="form-control" name="company_name">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Company Phone No</label>
						<input type="text" class="form-control" name="company_phone_no">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Company Address</label>
