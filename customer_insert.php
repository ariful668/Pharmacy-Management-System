  ...
  <body>
    ...
    <div class="container">
		<div class="bg-faded p-4 my-4">
			<hr class="divider">
			<h2 class="text-center text-lg text-uppercase my-0">Customer
				<strong>Form</strong>
			</h2>
			<hr class="divider">
			<form action="configuration/customerconfig.php" method="post">
				<center>
					<div class="row">
					<div class="form-group col-lg-12">
						<label class="text-heading">Customer ID</label>
						<input type="text" class="form-control" name="customer_id">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Customer Name</label>
						<input type="text" class="form-control" name="customer_name">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Customer Phone No</label>
						<input type="text" class="form-control" name="customer_phone_no">
					</div>
					<div class="form-group col-lg-12">
						<label class="text-heading">Customer Address</label>
