...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tb_drug` WHERE CONCAT(`drug_id`) LIKE '%".$valueToSearch."%'";
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <form action="drug_search.php" method="post">
				<center>
					<div class="row">
					<h3 style="margin-left: 466px;">Search By Drug ID</h3>
