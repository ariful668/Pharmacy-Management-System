...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tb_company` WHERE CONCAT(`company_invoice_id`) LIKE '%".$valueToSearch."%'";
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <form action="company_search.php" method="post">
				<center>
					<div class="row">
					<h3 style="margin-left: 466px;">Search By Company ID</h3>
				...
				<table class="table table-bordered table-striped">
					...
					<?php while($row = mysqli_fetch_array($search_result)):?>
						<tr>
							<td><?php echo $row['company_invoice_id'];?></td>
							<td><?php echo $row['company_name'];?></td>
							<td><?php echo $row['company_address'];?></td>
							<td><?php echo $row['company_phone_no'];?></td>
						</tr>
					<?php endwhile;?>
					</tbody>
				</table>	
