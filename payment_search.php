...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tb_payment` WHERE CONCAT(`payment_id`) LIKE '%".$valueToSearch."%'";
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <form action="payment_search.php" method="post">
				<center>
					<div class="row">
					<h3 style="margin-left: 466px;">Search By Payment ID</h3>
